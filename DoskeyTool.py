...
# Form implementation generated from reading ui file 'DoskeyTool.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SaveButton.setText(_translate("MainWindow", "Добавить"))
        self.label.setText(_translate("MainWindow", "Введите команду для создания alias:"))
        self.checkBoxRegistry.setText(_translate("MainWindow", "Записать путь в реестр для автозапуска doskey"))
    ...
    def buttonActions(self,isSaveRegistry): # 
        ...
        try:
            ...
            if isSaveRegistry == 2:
                self.setAutorun()
                message.setText("Команда была успешно добавлена. Путь к файлу doskey.bat был записан в реестр.")
            else:
                message.setText("Команда была успешно добавлена.")
            ...
            message.setText("Произошла ошибка при добавлении команды.")
